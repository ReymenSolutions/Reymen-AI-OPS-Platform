...
export function TemplatePackages({ packages, installedTemplateIds, orgIndustry, industryLabels }: TemplatePackagesProps) {
              ...
              <CardContent className="p-5">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    {isOrgIndustry && <Badge variant="default" className="text-xs">Tu industria</Badge>}
                ...
                <p className="text-xs text-slate-400 mb-4">
                  Incluye: {pkg.items.map((i) => i.template.name).join(", ")}
                </p>
