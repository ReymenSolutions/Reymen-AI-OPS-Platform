...
export const strings = {
  es: {
    ...
    pipelineDesc: "oportunidades activas",
    leadDetailTitle: "Detalle del lead",
    ofLeads: "de",
    ...
    adminFoodPosKeyLabel: "x-api-key (solo lectura, POS)",
    adminFoodPosKeyDesc: "Llave separada del secreto de arriba, solo para que un punto de venta lea el menú (GET /api/v1/food/menu) sin guardar la llave que firma órdenes.",
    adminFoodPosKeyGenerateBtn: "Generar",
    adminFoodPosKeyRotated: "Llave regenerada. Actualiza el POS con el nuevo valor.",
    adminFoodPosKeyRotateError: "Error al generar la llave",
    adminFoodPosKeyEmpty: "Todavía no se ha generado ninguna",
  ...
  en: {
    ...
    pipelineDesc: "active opportunities",
    ...
    adminFoodPosKeyLabel: "x-api-key (read-only, POS)",
    adminFoodPosKeyDesc: "Separate from the secret above — only lets a point-of-sale device read the menu (GET /api/v1/food/menu) without holding the key that signs orders.",
    adminFoodPosKeyGenerateBtn: "Generate",
    adminFoodPosKeyRotated: "Key regenerated. Update the POS with the new value.",
    adminFoodPosKeyRotateError: "Error generating the key",
    adminFoodPosKeyEmpty: "Not generated yet",
